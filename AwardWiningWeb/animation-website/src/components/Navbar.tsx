...
// Define nav items as a constant array with explicit type
const navItems: string[] = ["Nexus", "Vault", "Prologue", "About", "Contact"];

// Define component props interface (empty in this case since NavBar takes no props)
...
const NavBar: React.FC<NavBarProps> = () => {
  ...
  // Refs for audio and navigation container with proper typing
